...
/* 4 */
/*!*****************************************************!*\
  !*** /Users/bob/Documents/vue/uni-first/pages.json ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 11 */
/*!*********************************************************!*\
  !*** /Users/bob/Documents/vue/uni-first/store/store.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _amapWx = _interopRequireDefault(__webpack_require__(/*! ../common/amap-wx.js */ 13));var _mutations;function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var ADD_ADDRESS_FORM_VALUE = 'ADD_ADDRESS_FORM_VALUE';

var ADD_ADDRESS_LIST = 'ADD_ADDRESS_LIST';
...
var RESTAURANTS_URL = 'https://elm.cangdu.org/shopping/restaurants';
var RESTAURANTS = 'RESTAURANTS';

// https://elm.cangdu.org/v4/restaurants?geohash=31.22967,121.4762&keyword=肯德基
var SEARCH_RESTAURANTS_URL = 'https://elm.cangdu.org/v4/restaurants';
var SEARCH_RESTAURANTS = 'SEARCH_RESTAURANTS';

var FOOD_GROUP_URL = 'https://elm.cangdu.org/v2/index_entry';
var FOOD_GROUP = 'FOOD_GROUP';
...
ADD_ADDRESS_LIST, function (state, data) {
  state.addressList.push(_objectSpread({}, data, { id: state.addressList.length + 1 }));
}), _defineProperty(_mutations,
ADDRESS_LIST, function (state, data) {
  state.addressList = data;
}), _defineProperty(_mutations,
CURRENT_ADDRESS, function (state, data) {
  state.currentAddress = data;
}), _defineProperty(_mutations,
CURRENT_LOCATION, function (state, data) {
  state.currentLocation = data;
}), _defineProperty(_mutations,
LON_LAT, function (state, data) {
  state.lonLat = data;
}), _defineProperty(_mutations,
RESTAURANTS, function (state, data) {
  state.restaurants = data;
}), _defineProperty(_mutations,
SEARCH_RESTAURANTS, function (state, data) {
  state.restaurantsResult = data;
}), _defineProperty(_mutations,
FOOD_GROUP, function (state, data) {
  state.foodGroup = data;
}), _defineProperty(_mutations,
ADD_ADDRESS_FORM_VALUE, function (state, data) {
  state.addAddressFormValue = data;
}), _mutations);


var actions = {
  setAddAddressFormValue: function setAddAddressFormValue(_ref, data) {var commit = _ref.commit;
    commit(ADD_ADDRESS_FORM_VALUE, data);
  },
  addAddress: function addAddress(_ref2, data) {var commit = _ref2.commit;
    //will call end service and get response id
    commit(ADD_ADDRESS_LIST, data);
  },
  getAddressList: function getAddressList(_ref3, data) {var commit = _ref3.commit;
    var list = [
    {
      id: 1,
      name: 'bob',
  ...
  getCurrentLocation: function getCurrentLocation(_ref4) {var commit = _ref4.commit;
    amapPlugin.getRegeo({
  ...
  setCurrentAddress: function setCurrentAddress(_ref5, data) {var commit = _ref5.commit;
    commit(CURRENT_ADDRESS, data);
  },
  getRestaurants: function getRestaurants(_ref6, address) {var commit = _ref6.commit;
    uni.request({
      url: RESTAURANTS_URL,
      data: {
      ...
      success: function success(shopSummary) {
        commit(RESTAURANTS, shopSummary.data);
      } });

  },
  searchRestaurants: function searchRestaurants(_ref7, payload) {var commit = _ref7.commit;var
    address = payload.address,keyword = payload.keyword;
    var geohash = address.latitude + ',' + address.longitude;
    uni.request({
  ...
  getFoodGroup: function getFoodGroup(_ref8) {var commit = _ref8.commit;
    uni.request({
      url: FOOD_GROUP_URL,
      success: function success(foodGroups) {
        var length = foodGroups.data.length;
...
/* 13 */
/*!************************************************************!*\
  !*** /Users/bob/Documents/vue/uni-first/common/amap-wx.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
